import { ArrowLeft, Grid, Bookmark, List, Book } from "lucide-react";
              ...
              {savedJobList.length === 0 ? (
                <div className="text-center py-16 lg:py-20 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/20">
                  ...
                  <h3 className="text-xl lg:text-2xl font-bold text-gray-900 mb-3">
                    You haven't save any jobs yet
                  </h3>
                  <p className="text-gray-600 mb-6">
                    Start saving jobs that interest you view them later
                  </p>
                  <button
                    onClick={() => navigate("/find-jobs")}
                    className="bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-700 transition-colors cursor-pointer"
                  >
                    Browse Jobs
                  </button>
                </div>
